...
<body>
    ...
    <body>
        <div class="container1">
            <div class="col-auto folder-container mb-2 d-flex">
                <h1 class="text-center">{{ $folders->folder_name }}</h1>
                {{-- {{dd($images)}} --}}
                @foreach ($images as $image)
                    <div class="col-auto model_folder">
                        <label>
                            <img src="{{ $image->path_name }}" alt="{{ $image->picture_name }}" class="image" />
                            <input type="checkbox" class="checkbox" value="{{ $image->picture_name }}" />
                        </label>
                    </div>
                @endforeach
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        @foreach ($foldersall as $folders)
                            <h1 class="modal-title fs-5" id="staticBackdropLabel">
                              <div class="col-auto model_form">
